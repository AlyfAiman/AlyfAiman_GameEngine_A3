...
// A signal object can call multiple slots with the same signature.
// You can connect functions to the signal whcih will be called 
// when the emit() method on the signal object is invoked.
// Any argument passed to emit() will be passed to given functions.
...
public:
	...
	// Copy constructor and assignment creates new signal.
	Signal(Signal const&){}
